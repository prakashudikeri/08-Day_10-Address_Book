...
public class AddressBook {
    ...
    public void addNewContact() {											//Method to Add New Contact to AddressBook
    ...
    public void editContact() {													   //Method to Edit the Existing Contact
        System.out.println("Enter the First Name : ");								//Get First Name to Edit the Contact
        	String firstName = sc.next();
        boolean isAvailable = false;												        //check if the Given User with First Name
        	for(Contacts contact : contactList) {
    ...
    public void deleteContact() {														//Method to Delete the Existing Contact        
        System.out.println("Enter the First Name : ");									//Get First Name to Edit the Contact
        	String firstName = sc.next();       
        boolean isAvailable = false;													 //check if the Given User with First Name
        for(Contacts contact : contactList) {
    ...
    public void contactOptions(AddressBook addressBook) {								//Show Menu for user to Select Operation on AddressBook
        do {
